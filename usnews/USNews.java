 ...
 *   news.fetchAll(5, new String[]{"nyt","fox"}, new USNews.Callback() { ... });
 */
public class USNews {

    private static final int TIMEOUT = 12000;
    private static final String UA = "AutoClaw-USNews/1.0";
    ...
    public static class Article {
        ...
        public String error; // non-null if this entry represents an error
    ...
    static {
        ...
        SOURCE_NAMES.put("npr", "NPR");
    }

    private static final Map<String, String> SOURCE_FEEDS = new LinkedHashMap<>();
    static {
        SOURCE_FEEDS.put("nyt", "https://rss.nytimes.com/services/xml/rss/nyt/US.xml");
        SOURCE_FEEDS.put("fox", "https://moxie.foxnews.com/google-publisher/us.xml");
        SOURCE_FEEDS.put("npr", "https://feeds.npr.org/1001/rss.xml");
    }
    ...
    private static String fmtBrief(Map<String, List<Article>> allResults) {
        ...
        return "Top US News (" + now + ") - " + (idx - 1) + " articles from " + allResults.size() + " sources\n" + sb;
    }
