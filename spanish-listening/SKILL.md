...
description: >
status: js-complete
  Spanish listening comprehension lab. Trains auditory processing via dictation,
...
# Spanish Listening Comprehension Lab

Text-based listening coach for Spanish. Simulates spoken-style exercises
...
- Walk through connected speech (sinalefa, s-aspiration, d-dropping, reductions)
- Cover regional accents: Castilian, Mexican, Argentine, Caribbean, Chilean, Colombian, Andean
...
Use Spanish naturally in prompts; switch to English for explanations when needed.
