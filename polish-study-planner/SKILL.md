---
name: polish-study-planner
description: >
status: js-complete
  Polish fluency study planner and progress coach. Adaptive placement test,
  personalized weekly plans, FSRS-based spaced repetition across 7 skill areas.
  Includes Certyfikat Znajomości Języka Polskiego exam prep.
  tutor.js is COMPLETE.
---

# Polish Study Planner
...
5 adaptive questions (A1-C1) covering Polish-specific topics:
- A1: basic być sentences
- A2: past tense gender marking
- B1: conditional mood (gdybym)
- B2: aspect choice in context
- C1: formal register / impersonal constructions
...
- Can-Do milestones bilingual (English + Polish)
- Polish-specific placement: tests gender-marked past tense, aspect, conditional
