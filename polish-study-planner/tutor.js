...
const SKILL_NAME = 'polish-study-planner';
...
// ── CEFR Can-Do milestones (bilingual: English + Polish) ─────────────────

const CANDO_MILESTONES = {
  A1: [
    { en: 'I can introduce myself and ask simple questions about personal details.',
      pl: 'Potrafię się przedstawić i zadawać proste pytania o dane osobowe.' },
    { en: 'I can understand familiar everyday expressions and very basic phrases.',
      pl: 'Rozumiem znane wyrażenia codzienne i bardzo podstawowe zwroty.' },
    { en: 'I can interact in a simple way if the other person talks slowly.',
      pl: 'Potrafię prowadzić prostą rozmowę, jeśli druga osoba mówi powoli.' },
  ],
  A2: [
    { en: 'I can describe my daily routine and understand short, simple messages.',
      pl: 'Potrafię opisać swoją codzienną rutynę i rozumiem krótkie, proste wiadomości.' },
    { en: 'I can communicate in simple tasks requiring a direct exchange of information.',
      pl: 'Potrafię porozumiewać się w prostych sytuacjach wymagających bezpośredniej wymiany informacji.' },
    { en: 'I can describe aspects of my background, immediate environment, and basic needs.',
      pl: 'Potrafię opisać swoje otoczenie i podstawowe potrzeby.' },
  ],
  B1: [
    { en: 'I can deal with most situations likely to arise while traveling in Poland.',
      pl: 'Radzę sobie w większości sytuacji, które mogą pojawić się podczas podróży po Polsce.' },
    { en: 'I can describe experiences, events, dreams, and briefly give reasons and explanations.',
      pl: 'Potrafię opisać doświadczenia, wydarzenia, marzenia i krótko podać powody i wyjaśnienia.' },
    { en: 'I can understand the main points of clear standard speech on familiar matters.',
      pl: 'Rozumiem główne punkty jasnej, standardowej wypowiedzi na znane tematy.' },
  ],
  B2: [
    { en: 'I can interact with a degree of fluency that makes regular interaction with native speakers quite possible.',
      pl: 'Potrafię rozmawiać z wystarczającą płynnością, by regularnie komunikować się z native speakerami.' },
    { en: 'I can produce clear, detailed text on a wide range of subjects.',
      pl: 'Potrafię tworzyć jasne, szczegółowe teksty na szeroką gamę tematów.' },
    { en: 'I can understand the main ideas of complex text on both concrete and abstract topics.',
      pl: 'Rozumiem główne idee złożonych tekstów na tematy konkretne i abstrakcyjne.' },
  ],
  C1: [
    { en: 'I can express myself fluently and spontaneously without much obvious searching for expressions.',
      pl: 'Potrafię wyrażać się płynnie i spontanicznie, bez wyraźnego szukania słów.' },
    { en: 'I can use language flexibly and effectively for social, academic, and professional purposes.',
      pl: 'Potrafię używać języka elastycznie i skutecznie w celach społecznych, akademickich i zawodowych.' },
    { en: 'I can understand a wide range of demanding, longer texts and recognize implicit meaning.',
      pl: 'Rozumiem szeroką gamę wymagających, dłuższych tekstów i rozpoznaję znaczenia ukryte.' },
  ],
  C2: [
    { en: 'I can summarize information from different spoken and written sources, reconstructing arguments coherently.',
      pl: 'Potrafię streszczać informacje z różnych źródeł ustnych i pisemnych, odtwarzając argumenty w sposób spójny.' },
    { en: 'I can express myself spontaneously, very fluently, and precisely, differentiating finer shades of meaning.',
      pl: 'Potrafię wyrażać się spontanicznie, z dużą płynnością i precyzją, rozróżniając subtelne odcienie znaczeń.' },
  ],
};
...
const PLACEMENT_QUESTIONS = [
  {
    level: 'A1',
    topic: 'być — basic sentence',
    prompt: 'Uzupełnij: "Ona ___ studentką."',
    options: ['jest', 'ma', 'są'],
    answer: 0,
    hints: [
      'Think about which verb describes identity or profession in Polish.',
      'This sentence needs the verb "być" (to be) for identity.',
      'It is either (a) or (b).',
    ],
  },
  {
    level: 'A2',
    topic: 'past tense gender marking',
    prompt: 'Uzupełnij: "Wczoraj Anna ___ do kina."',
    options: ['poszła', 'poszedł', 'idzie'],
    answer: 0,
    hints: [
      '"Wczoraj" means yesterday — what tense is needed? And Anna is female.',
      'Past tense in Polish marks gender: feminine -ła, masculine -ł.',
      'It is either (a) or (b).',
    ],
  },
  {
    ...
    prompt: 'Uzupełnij: "Gdybym miał więcej czasu, ___ do Krakowa."',
    options: ['jadę', 'pojechałbym', 'pojadę'],
    answer: 1,
    hints: [
      '"Gdybym" (if I) starts a conditional clause. What pairs with it?',
      'Polish conditional uses -bym/-byś/-by suffixes on the past tense form.',
      'It is either (a) or (b).',
    ],
  },
  {
    level: 'B2',
    topic: 'aspect choice in context',
    prompt: 'Uzupełnij: "Wczoraj cały dzień ___ tę książkę." (czytać/przeczytać)',
    options: ['czytałem', 'przeczytałem', 'czytam'],
    answer: 0,
    hints: [
      '"Cały dzień" (all day) emphasizes duration. Which aspect expresses ongoing process?',
      'Imperfective aspect is for ongoing/repeated actions. Perfective is for completed ones.',
      'It is either (a) or (b).',
    ],
  },
  {
    level: 'C1',
    topic: 'formal register + impersonal construction',
    prompt: 'Uzupełnij: "Konieczne jest, ___ podjęto odpowiednie środki."',
    options: ['że', 'aby', 'bo'],
    answer: 1,
    hints: [
      '"Konieczne jest" (it is necessary) requires a specific conjunction for purpose/obligation.',
      'Polish uses "aby" or "żeby" after expressions of necessity, similar to subjunctive triggers.',
      'It is either (a) or (b).',
    ],
  },
];
...
class StudyPlanner {
  ...
  generateWeeklyPlan(id) {
    ...
    plan.Sun = { skills: [], minutes: {}, type: 'rest', note: 'Odpoczynek lub 5-minutowy szybki przegląd FSRS' };
  ...
  getTodaySession(id) {
    ...
    return {
      ...
      level: p.level,
      session: {
        retrievalWarmup: '3-5 min: przypomnij sobie elementy z poprzednich sesji przed przeglądem',
      ...
      streak,
      motivation: streak > 0
        ? `Seria ${streak} dni! Kontynuuj budowanie impetu.`
        : 'Zacznij nową serię dzisiaj. Każda sesja się liczy.',
    };
  }
  ...
  getReport(id) {
    ...
    return {
      ...dash,
      report: {
        currentMilestones: milestones.map(m => ({ achieved: lvl, en: m.en, pl: m.pl })),
        nextLevel: nextLvl || 'max',
        nextMilestones: nextMilestones.map(m => ({ target: nextLvl, en: m.en, pl: m.pl })),
  ...
  _recommendation(p) {
    ...
    if (streak === 0) {
      parts.push('Zacznij nową serię dzisiaj. Regularność wygrywa z intensywnością.');
    } else if (streak >= 7) {
      parts.push(`Świetna seria ${streak} dni! Rozważ zwiększenie dziennego budżetu.`);
    }

    const wd = p.skills[weakest];
    const wAcc = wd.items > 0 ? Math.round(wd.correct / wd.items * 100) : 0;
    parts.push(`Skup się na ${weakest} (${wAcc}% trafności) — ta umiejętność hamuje twój ogólny poziom.`);

    for (const sk of SKILL_LIST) {
      const d = p.skills[sk];
      if (d.lastPractice && this._daysSince(d.lastPractice) >= 5) {
        parts.push(`${sk} nie ćwiczono od ${this._daysSince(d.lastPractice)} dni — zaplanuj sesję wkrótce.`);
      }
    }
  ...
  switch (cmd) {
    case 'start': {
      ...
      out({
        ...
        budget: p.budget,
        message: p.level
          ? `Witaj ponownie! Poziom: ${p.level}, Cel: ${p.goal || 'nie ustawiony'}, Budżet: ${p.budget}min`
          : 'Nowy student utworzony. Uruchom placement, set-goal i set-budget, aby zacząć.',
      });
      break;
    }
