---
name: russian-study-planner
status: js-complete
description: >
  Russian fluency study planner and progress coach. Adaptive placement test,
  personalized weekly plans, FSRS-based spaced repetition across 7 skill areas.
  Includes TORFL exam prep and Cyrillic literacy check. Trigger: "plan my week",
  "what should I study", "my progress", "take placement test".
---

# Russian Study Planner
...
| heritage | 15 | 10 | 25 | 15 | 15 | 10 | 10 |

## Scheduling Rules

- No same skill two consecutive days (except Cyrillic intensive)
...
- Cyrillic-illiterate learners get intensive reading/writing override

## Placement Test

5 adaptive questions (A1-C1) with Cyrillic literacy pre-check.
Level = highest where learner scores with mediation 0-2.
Mediation 3-4 = ZPD targets. Mediation 5 = beyond reach.
...
- Can-Do milestones bilingual (English + Russian)
- Heritage goal added for learners reconnecting with family language
- Cyrillic literacy tracked separately; overrides plan if needed
