...
const CANDO_MILESTONES = {
  A1: [
    { en: 'I can introduce myself and ask simple questions about personal details.',
      es: 'Puedo presentarme y hacer preguntas sencillas sobre datos personales.' },
    { en: 'I can understand familiar everyday expressions and very basic phrases.',
      es: 'Puedo comprender expresiones cotidianas y frases muy básicas.' },
    { en: 'I can interact in a simple way if the other person talks slowly.',
      es: 'Puedo interactuar de forma sencilla si la otra persona habla despacio.' },
  ],
  A2: [
    { en: 'I can describe my daily routine and understand short, simple messages.',
      es: 'Puedo describir mi rutina diaria y entender mensajes cortos y sencillos.' },
    { en: 'I can communicate in simple tasks requiring a direct exchange of information.',
      es: 'Puedo comunicarme en tareas sencillas que requieren un intercambio directo de información.' },
    { en: 'I can describe aspects of my background, immediate environment, and basic needs.',
      es: 'Puedo describir aspectos de mi entorno inmediato y necesidades básicas.' },
  ],
  B1: [
    { en: 'I can deal with most situations likely to arise while traveling in a Spanish-speaking country.',
      es: 'Puedo desenvolverme en la mayoría de las situaciones que surgen al viajar por un país hispanohablante.' },
    { en: 'I can describe experiences, events, dreams, and briefly give reasons and explanations.',
      es: 'Puedo describir experiencias, acontecimientos, sueños y dar brevemente razones y explicaciones.' },
    { en: 'I can understand the main points of clear standard speech on familiar matters.',
      es: 'Puedo comprender los puntos principales de textos claros sobre temas conocidos.' },
  ],
  B2: [
    { en: 'I can interact with a degree of fluency that makes regular interaction with native speakers quite possible.',
      es: 'Puedo interactuar con suficiente fluidez para mantener conversaciones regulares con hablantes nativos.' },
    { en: 'I can produce clear, detailed text on a wide range of subjects.',
      es: 'Puedo producir textos claros y detallados sobre una amplia variedad de temas.' },
    { en: 'I can understand the main ideas of complex text on both concrete and abstract topics.',
      es: 'Puedo comprender las ideas principales de textos complejos sobre temas concretos y abstractos.' },
  ],
  C1: [
    { en: 'I can express myself fluently and spontaneously without much obvious searching for expressions.',
      es: 'Puedo expresarme con fluidez y espontaneidad sin tener que buscar expresiones de manera evidente.' },
    { en: 'I can use language flexibly and effectively for social, academic, and professional purposes.',
      es: 'Puedo usar la lengua de manera flexible y eficaz para fines sociales, académicos y profesionales.' },
    { en: 'I can understand a wide range of demanding, longer texts and recognize implicit meaning.',
      es: 'Puedo comprender una amplia variedad de textos extensos y exigentes y reconocer sentidos implícitos.' },
  ],
  C2: [
    { en: 'I can summarize information from different spoken and written sources, reconstructing arguments coherently.',
      es: 'Puedo resumir información de distintas fuentes orales y escritas, reconstruyendo argumentos de forma coherente.' },
    { en: 'I can express myself spontaneously, very fluently, and precisely, differentiating finer shades of meaning.',
      es: 'Puedo expresarme espontáneamente, con gran fluidez y precisión, diferenciando matices sutiles de significado.' },
  ],
};
...
const PLACEMENT_QUESTIONS = [
  {
    ...
    prompt: 'Complete: "Ella ___ estudiante."',
    options: ['es', 'esta', 'hay'],
    answer: 0,
    hints: [
  ...
  },
  {
    ...
    prompt: 'Complete: "Ayer ___ al supermercado."',
    options: ['fui', 'iba', 'voy'],
    answer: 0,
    hints: [
      'The word "ayer" tells you the tense. Think about completed past actions.',
      'This is a completed action — use the preterite, not the imperfect.',
      'It is either (a) or (b).',
    ],
  },
  {
    ...
    prompt: 'Complete: "Espero que María ___ a la fiesta."',
    options: ['viene', 'venga', 'vendrá'],
    answer: 1,
    hints: [
      '"Espero que" expresses a wish. What mood does that trigger?',
      'After "espero que" you need the subjunctive. Try again.',
      'It is either (a) or (b).',
    ],
  },
  {
    level: 'B2',
    topic: 'conditional + past subjunctive',
    prompt: 'Complete: "Si yo ___ más dinero, viajaría por el mundo."',
    options: ['tengo', 'tuviera', 'tendré'],
    answer: 1,
    hints: [
      'This is a hypothetical "if" clause. What tense pairs with the conditional?',
      'Hypothetical "si" clauses need the past subjunctive (imperfecto de subjuntivo).',
      'It is either (a) or (b).',
    ],
  },
  {
    ...
    prompt: 'Complete: "Es imprescindible que se ___ las medidas necesarias."',
    options: ['toman', 'tomen', 'tomaran'],
    answer: 1,
    hints: [
      '"Es imprescindible que" demands a specific mood. Which one?',
...
class StudyPlanner {
  constructor() {
    this.dir = core.dataDir('spanish-study-planner');
  ...
  getReport(id) {
    ...
    return {
      ...dash,
      report: {
        currentMilestones: milestones.map(m => ({ achieved: lvl, en: m.en, es: m.es })),
        nextLevel: nextLvl || 'max',
        nextMilestones: nextMilestones.map(m => ({ target: nextLvl, en: m.en, es: m.es })),
