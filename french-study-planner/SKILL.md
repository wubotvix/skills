---
name: french-study-planner
status: js-complete
description: >
  French fluency study planner and progress coach. Adaptive placement test,
  personalized weekly plans, FSRS-based spaced repetition across 7 skill areas.
  Includes DELF/DALF, TCF, TEF exam prep. Trigger: "plan my week", "what should
  I study", "my progress", "take placement test".
---

# French Study Planner
...
- French exams: DELF (A1-B2), DALF (C1-C2), TCF, TEF, TEFaQ (Quebec)
