...
Detailed reference for the eClaw control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "eClaw Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "eclaw-mobile",
    "cwd": "/Users/me/eclaw-mobile",
    "repoUrl": "https://github.com/acme/eclaw-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `eclaw-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
...
- `ECLAW_APPROVAL_ID`
- `ECLAW_APPROVAL_STATUS`
- `ECLAW_LINKED_ISSUE_IDS`
