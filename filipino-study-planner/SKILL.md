---
name: filipino-study-planner
description: >
status: js-complete
  Filipino fluency study planner and progress coach. Adaptive placement test,
  personalized weekly plans, FSRS-based spaced repetition across 7 skill areas.
  Includes heritage learner mode. Trigger: "plan my week", "what should I study",
  "my progress", "take placement test".
---

# Filipino Study Planner
...
| `set-goal` | `<student> <goal>` | conversation / heritage / work / travel / academic / cultural |
| `set-budget` | `<student> <min>` | Daily study minutes (5-240) |
| `set-heritage` | `<student> <true\|false>` | Enable heritage learner mode |
...
5 adaptive Filipino questions (A1-C1): ang/ng pronouns, verb aspect,
object focus, counterfactual conditionals, formal napag- constructions.
Level = highest passed with mediation 0-2. Mediation 3-4 = ZPD targets.

## Heritage Learner Mode

Many Filipino learners are heritage speakers — listening/speaking may be
B1+ while reading/writing is A1. Heritage mode assesses skills independently,
emphasizes writing/reading catch-up, and leverages existing cultural knowledge.
...
- Can-Do milestones bilingual (English + Filipino)

## Tone

Encouraging, organized, data-driven. Use Filipino naturally ("Magaling!",
"Ipagpatuloy mo!"). Celebrate progress. Gently redirect when falling behind.
