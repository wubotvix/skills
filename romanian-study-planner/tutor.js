...
const SKILL_NAME = 'romanian-study-planner';
...
const CANDO_MILESTONES = {
  A1: [
    { en: 'I can introduce myself and ask simple questions about personal details.',
      ro: 'Pot să mă prezint și să pun întrebări simple despre date personale.' },
    { en: 'I can understand familiar everyday expressions and very basic phrases.',
      ro: 'Pot să înțeleg expresii cotidiene familiare și fraze foarte simple.' },
    { en: 'I can interact in a simple way if the other person talks slowly.',
      ro: 'Pot să interacționez simplu dacă cealaltă persoană vorbește încet.' },
  ],
  A2: [
    { en: 'I can describe my daily routine and understand short, simple messages.',
      ro: 'Pot să descriu rutina zilnică și să înțeleg mesaje scurte și simple.' },
    { en: 'I can communicate in simple tasks requiring a direct exchange of information.',
      ro: 'Pot să comunic în sarcini simple care necesită un schimb direct de informații.' },
    { en: 'I can describe aspects of my background, immediate environment, and basic needs.',
      ro: 'Pot să descriu aspecte ale mediului meu imediat și nevoi de bază.' },
  ],
  B1: [
    { en: 'I can deal with most situations likely to arise while traveling in Romania.',
      ro: 'Pot să mă descurc în majoritatea situațiilor care apar în timpul călătoriilor prin România.' },
    { en: 'I can describe experiences, events, dreams, and briefly give reasons and explanations.',
      ro: 'Pot să descriu experiențe, evenimente, vise și să dau pe scurt motive și explicații.' },
    { en: 'I can understand the main points of clear standard speech on familiar matters.',
      ro: 'Pot să înțeleg punctele principale ale unui discurs clar pe teme familiare.' },
  ],
  B2: [
    { en: 'I can interact with a degree of fluency that makes regular interaction with native speakers quite possible.',
      ro: 'Pot să interacționez cu suficientă fluență pentru a avea conversații regulate cu vorbitori nativi.' },
    { en: 'I can produce clear, detailed text on a wide range of subjects.',
      ro: 'Pot să produc texte clare și detaliate pe o gamă largă de subiecte.' },
    { en: 'I can understand the main ideas of complex text on both concrete and abstract topics.',
      ro: 'Pot să înțeleg ideile principale ale textelor complexe pe teme concrete și abstracte.' },
  ],
  C1: [
    { en: 'I can express myself fluently and spontaneously without much obvious searching for expressions.',
      ro: 'Pot să mă exprim fluent și spontan fără căutare evidentă de expresii.' },
    { en: 'I can use language flexibly and effectively for social, academic, and professional purposes.',
      ro: 'Pot să folosesc limba flexibil și eficient în scopuri sociale, academice și profesionale.' },
    { en: 'I can understand a wide range of demanding, longer texts and recognize implicit meaning.',
      ro: 'Pot să înțeleg o gamă largă de texte extinse și exigente și să recunosc sensuri implicite.' },
  ],
  C2: [
    { en: 'I can summarize information from different spoken and written sources, reconstructing arguments coherently.',
      ro: 'Pot să rezum informații din surse orale și scrise diferite, reconstruind argumente în mod coerent.' },
    { en: 'I can express myself spontaneously, very fluently, and precisely, differentiating finer shades of meaning.',
      ro: 'Pot să mă exprim spontan, cu mare fluență și precizie, diferențiind nuanțe subtile de sens.' },
  ],
};
...
const PLACEMENT_QUESTIONS = [
  {
    level: 'A1',
    topic: 'a fi — basic sentence',
    prompt: 'Complete: "Eu ___ student."',
    options: ['sunt', 'am', 'este'],
    answer: 0,
    hints: [
      'Think about which verb means "to be" in Romanian.',
      'This sentence needs the verb "a fi" (to be) conjugated for "eu."',
      'It is either (a) or (c).',
    ],
  },
  {
    level: 'A2',
    topic: 'perfectul compus (past tense)',
    prompt: 'Complete: "Ieri ___ la cinema."',
    options: ['am mers', 'mergeam', 'merg'],
    answer: 0,
    hints: [
      'The word "ieri" (yesterday) tells you the tense. Think about completed past actions.',
      'This is a completed action — use the perfectul compus (compound past), not the imperfect.',
      'It is either (a) or (b).',
    ],
  },
  {
    level: 'B1',
    topic: 'subjunctive with să',
    prompt: 'Complete: "Vreau ___ merg la mare."',
    options: ['că', 'să', 'de'],
    answer: 1,
    hints: [
      '"Vreau" (I want) triggers a specific construction in Romanian. What follows "vreau"?',
      'After "vreau" you need the subjunctive particle "să" + verb. Romanian uses subjunctive where English uses infinitive.',
      'It is either (a) or (b).',
    ],
  },
  {
    level: 'B2',
    topic: 'conditional',
    prompt: 'Complete: "Dacă ___ mai mult timp, aș călători prin Europa."',
    options: ['am', 'aș avea', 'aș fi avut'],
    answer: 1,
    hints: [
      'This is a hypothetical "if" clause. What tense pairs with "aș călători" (conditional)?',
      'Hypothetical "dacă" clauses need the conditional (condiționalul prezent): "dacă aș avea...".',
      'It is either (a) or (b).',
    ],
  },
  {
    level: 'C1',
    topic: 'presumptive mood',
    prompt: 'Complete: "Nu răspunde la telefon. ___ dormind."',
    options: ['Este', 'O fi', 'Va fi'],
    answer: 1,
    hints: [
      'This expresses a supposition or guess. Romanian has a special mood for this.',
      'The presumptive mood (prezumtivul) uses "o fi" to express probability or speculation.',
      'It is either (a) or (b).',
    ],
  },
];
...
class StudyPlanner {
  ...
  getReport(id) {
    ...
    return {
      ...dash,
      report: {
        currentMilestones: milestones.map(m => ({ achieved: lvl, en: m.en, ro: m.ro })),
        nextLevel: nextLvl || 'max',
        nextMilestones: nextMilestones.map(m => ({ target: nextLvl, en: m.en, ro: m.ro })),
...
core.runCLI((cmd, args, out) => {
  switch (cmd) {
    ...
    case 'placement': {
      ...
      // answers can be passed as JSON: [{"choice":0,"mediation":0}, ...]
      let answers = null;
      if (args[2]) {
