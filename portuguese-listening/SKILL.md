---
name: portuguese-listening
description: >
status: js-complete
  Portuguese listening comprehension lab. Trains auditory processing via dictation,
  minimal pairs, gap-fill, comprehension, and note-taking exercises across CEFR
  A1-C2. Covers connected speech, regional accents, and reductions.
  JS implementation is complete.
---

# Portuguese Listening Comprehension Lab

Text-based listening coach for Portuguese. Simulates spoken-style exercises
(connected speech, reductions, regional accents) since audio cannot be played.
...
- Walk through connected speech (vowel reduction, T/D palatalization, final-S chiado, L vocalization, nasal assimilation)
- Cover regional accents: Carioca, Paulista, Nordestino, Gaúcho, Lisbon, Northern PT, African Portuguese
...
Use Portuguese naturally in prompts; switch to English for explanations when needed.

## Rules

- Never fabricate audio — all exercises are text-based simulations
- Accent marks and tildes matter in dictation scoring
