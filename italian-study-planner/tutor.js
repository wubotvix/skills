...
const SKILL_NAME = 'italian-study-planner';
...
const CANDO_MILESTONES = {
  A1: [
    { en: 'I can introduce myself and ask simple questions about personal details.',
      it: 'Posso presentarmi e fare domande semplici su dati personali.' },
    { en: 'I can understand familiar everyday expressions and very basic phrases.',
      it: 'Posso comprendere espressioni quotidiane e frasi molto basilari.' },
    { en: 'I can interact in a simple way if the other person talks slowly.',
      it: "Posso interagire in modo semplice se l'altra persona parla lentamente." },
  ],
  A2: [
    { en: 'I can describe my daily routine and understand short, simple messages.',
      it: 'Posso descrivere la mia routine quotidiana e capire messaggi brevi e semplici.' },
    { en: 'I can communicate in simple tasks requiring a direct exchange of information.',
      it: 'Posso comunicare in compiti semplici che richiedono uno scambio diretto di informazioni.' },
    { en: 'I can describe aspects of my background, immediate environment, and basic needs.',
      it: 'Posso descrivere aspetti del mio ambiente circostante e bisogni basilari.' },
  ],
  B1: [
    { en: 'I can deal with most situations likely to arise while traveling in Italy.',
      it: 'Posso cavarmela nella maggior parte delle situazioni che si presentano viaggiando in Italia.' },
    { en: 'I can describe experiences, events, dreams, and briefly give reasons and explanations.',
      it: 'Posso descrivere esperienze, eventi, sogni e dare brevemente ragioni e spiegazioni.' },
    { en: 'I can understand the main points of clear standard speech on familiar matters.',
      it: 'Posso comprendere i punti principali di testi chiari su argomenti familiari.' },
  ],
  B2: [
    { en: 'I can interact with a degree of fluency that makes regular interaction with native speakers quite possible.',
      it: 'Posso interagire con sufficiente scioltezza da rendere possibili conversazioni regolari con madrelingua.' },
    { en: 'I can produce clear, detailed text on a wide range of subjects.',
      it: 'Posso produrre testi chiari e dettagliati su una vasta gamma di argomenti.' },
    { en: 'I can understand the main ideas of complex text on both concrete and abstract topics.',
      it: 'Posso comprendere le idee principali di testi complessi su argomenti concreti e astratti.' },
  ],
  C1: [
    { en: 'I can express myself fluently and spontaneously without much obvious searching for expressions.',
      it: 'Posso esprimermi con scioltezza e spontaneita senza dover cercare le espressioni in modo evidente.' },
    { en: 'I can use language flexibly and effectively for social, academic, and professional purposes.',
      it: 'Posso usare la lingua in modo flessibile ed efficace per scopi sociali, accademici e professionali.' },
    { en: 'I can understand a wide range of demanding, longer texts and recognize implicit meaning.',
      it: "Posso comprendere un'ampia varieta di testi lunghi e complessi e riconoscere significati impliciti." },
  ],
  C2: [
    { en: 'I can summarize information from different spoken and written sources, reconstructing arguments coherently.',
      it: 'Posso riassumere informazioni da diverse fonti orali e scritte, ricostruendo argomenti in modo coerente.' },
    { en: 'I can express myself spontaneously, very fluently, and precisely, differentiating finer shades of meaning.',
      it: 'Posso esprimermi spontaneamente, con grande scioltezza e precisione, differenziando sfumature sottili di significato.' },
  ],
};
...
const PLACEMENT_QUESTIONS = [
  {
    level: 'A1',
    topic: 'essere — basic sentence',
    prompt: 'Complete: "Lei ___ studentessa."',
    options: ['e', 'ha', 'sta'],
    answer: 0,
    hints: [
      'Think about which verb describes identity or profession.',
      'This sentence needs the verb "essere" for identity.',
      'It is either (a) or (b).',
    ],
  },
  {
    ...
    prompt: 'Complete: "Ieri ___ al supermercato."',
    options: ['sono andato', 'andavo', 'vado'],
    answer: 0,
    hints: [
      'The word "ieri" tells you the tense. Think about completed past actions.',
      'This is a completed action — use the passato prossimo with "andare" (essere + past participle).',
      'It is either (a) or (b).',
    ],
  },
  {
    level: 'B1',
    topic: 'congiuntivo',
    prompt: 'Complete: "Spero che Maria ___ alla festa."',
    options: ['viene', 'venga', 'verra'],
    answer: 1,
    hints: [
      '"Spero che" expresses a wish. What mood does that trigger?',
      'After "spero che" you need the congiuntivo. Try again.',
      'It is either (a) or (b).',
    ],
  },
  {
    level: 'B2',
    topic: 'periodo ipotetico + congiuntivo imperfetto',
    prompt: 'Complete: "Se io ___ piu soldi, viaggerei per il mondo."',
    options: ['ho', 'avessi', 'avro'],
    answer: 1,
    hints: [
      'This is a hypothetical "if" clause. What tense pairs with the condizionale?',
      'Hypothetical "se" clauses need the congiuntivo imperfetto.',
      'It is either (a) or (b).',
    ],
  },
  {
    level: 'C1',
    topic: 'formal register + congiuntivo',
    prompt: 'Complete: "E indispensabile che si ___ le misure necessarie."',
    options: ['prendono', 'prendano', 'prendessero'],
    answer: 1,
    hints: [
      '"E indispensabile che" demands a specific mood. Which one?',
      'Impersonal expressions of necessity require the congiuntivo presente.',
      'It is either (a) or (b).',
    ],
  },
];
...
class StudyPlanner {
  ...
  getReport(id) {
    ...
    return {
      ...dash,
      report: {
        currentMilestones: milestones.map(m => ({ achieved: lvl, en: m.en, it: m.it })),
        nextLevel: nextLvl || 'max',
        nextMilestones: nextMilestones.map(m => ({ target: nextLvl, en: m.en, it: m.it })),
