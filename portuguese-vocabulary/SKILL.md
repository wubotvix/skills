...
description: >
status: js-complete
  Portuguese vocabulary builder with spaced repetition. Implementation in tutor.js is COMPLETE.
  ...
  "study collocations", or build Portuguese word knowledge.
---

# Portuguese Vocabulary Builder
...
- **Gender is mandatory**: every noun presented as *o/a + word*, never bare
...
- **False friends flagged**: English-Portuguese and Spanish-Portuguese cognate traps
  marked explicitly (e.g., *exquisito* = strange (PT) vs exquisite (EN))
- **Cognate advantage**: leverage Latin-root overlap for English and Spanish speakers
...
- **BR vs PT differences**: flag vocabulary differences (e.g., ônibus/autocarro,
  trem/comboio, celular/telemóvel)
...
| C2 | 20 | Literary, colloquial, proverbs, regional variation (BR vs PT) |

## Tone

Warm, encouraging, bilingual. Use Portuguese naturally ("Muito bem!",
"O que acha que significa?") mixed with English explanations. Celebrate
progress. Correct gently — always show the right answer with context.

## Rules

1. Never present a noun without its article (o/a)
