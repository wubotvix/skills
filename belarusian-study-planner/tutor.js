...
const SKILL_NAME = 'belarusian-study-planner';
...
const GOAL_ALLOCATIONS = {
  ...
  heritage:     { vocabulary: 25, grammar: 10, conversation: 20, pronunciation: 15, reading: 15, writing: 5,  listening: 10 },
};
...
const CANDO_MILESTONES = {
  A1: [
    { en: 'I can introduce myself and ask simple questions about personal details.',
      be: 'Магу прадставіцца і задаць простыя пытанні пра асабістыя дадзеныя.' },
    { en: 'I can understand familiar everyday expressions and very basic phrases.',
      be: 'Магу зразумець знаёмыя штодзённыя выразы і самыя простыя фразы.' },
    { en: 'I can interact in a simple way if the other person talks slowly.',
      be: 'Магу ўзаемадзейнічаць простым чынам, калі суразмоўца гаворыць павольна.' },
  ],
  A2: [
    { en: 'I can describe my daily routine and understand short, simple messages.',
      be: 'Магу апісаць свой дзень і зразумець кароткія простыя паведамленні.' },
    { en: 'I can communicate in simple tasks requiring a direct exchange of information.',
      be: 'Магу мець зносіны ў простых задачах, якія патрабуюць прамога абмену інфармацыяй.' },
    { en: 'I can describe aspects of my background, environment, and basic needs.',
      be: 'Магу апісаць аспекты свайго асяроддзя і асноўныя патрэбы.' },
  ],
  B1: [
    { en: 'I can deal with most situations likely to arise while in Belarus.',
      be: 'Магу справіцца з большасцю сітуацый, якія ўзнікаюць у Беларусі.' },
    { en: 'I can describe experiences, events, dreams, and briefly give reasons.',
      be: 'Магу апісаць перажыванні, падзеі, мары і коратка даць прычыны.' },
    { en: 'I can understand the main points of clear standard speech on familiar matters.',
      be: 'Магу зразумець асноўныя думкі ясных стандартных тэкстаў на знаёмыя тэмы.' },
  ],
  B2: [
    { en: 'I can interact with a degree of fluency that makes regular interaction with native speakers quite possible.',
      be: 'Магу ўзаемадзейнічаць з дастатковай плаўнасцю для рэгулярных размоў з носьбітамі мовы.' },
    { en: 'I can produce clear, detailed text on a wide range of subjects.',
      be: 'Магу ствараць ясныя, падрабязныя тэксты на шырокую тэматыку.' },
    { en: 'I can understand the main ideas of complex text on concrete and abstract topics.',
      be: 'Магу зразумець галоўныя ідэі складаных тэкстаў на канкрэтныя і абстрактныя тэмы.' },
  ],
  C1: [
    { en: 'I can express myself fluently and spontaneously without much obvious searching for expressions.',
      be: 'Магу свабодна выказваць думкі без прыкметнага пошуку слоў.' },
    { en: 'I can use language flexibly and effectively for social, academic, and professional purposes.',
      be: 'Магу выкарыстоўваць мову гнутка і эфектыўна для сацыяльных, навуковых і прафесійных мэтаў.' },
    { en: 'I can understand a wide range of demanding, longer texts and recognize implicit meaning.',
      be: 'Магу зразумець шырокі набор складаных, доўгіх тэкстаў і ўлавіць скрыты сэнс.' },
  ],
  C2: [
    { en: 'I can summarize information from different sources, reconstructing arguments coherently.',
      be: 'Магу абагульняць інфармацыю з розных крыніц, узнаўляючы аргументы складна.' },
    { en: 'I can express myself spontaneously, very fluently, differentiating finer shades of meaning.',
      be: 'Магу выказвацца спантанна, з вялікай плаўнасцю, адрозніваючы тонкія адценні значэння.' },
  ],
};
...
const PLACEMENT_QUESTIONS = [
  {
    level: 'A1',
    topic: 'basic sentence — gender',
    prompt: 'Complete: "Гэта ___." (a) кніга (b) кнігі (c) кнізе',
    options: ['кніга', 'кнігі', 'кнізе'],
    answer: 0,
    hints: [
      'This sentence needs a noun in the nominative case.',
      '"Гэта" (this is) requires the nominative form.',
      'It is either (a) or (b).',
    ],
  },
  {
    level: 'A2',
    topic: 'past tense with -ў',
    prompt: 'Complete: "Учора яна ___ дадому." (a) ісці (b) ішла (c) ішоў',
    options: ['ісці', 'ішла', 'ішоў'],
    answer: 1,
    hints: [
      '"Учора" tells you this is past tense. Think about the feminine form.',
      'Яна (she) needs the feminine past tense form.',
      'It is either (a) or (b).',
    ],
  },
  {
    level: 'B1',
    topic: 'locative case',
    prompt: 'Complete: "Я жыву ў ___." (a) Мінск (b) Мінску (c) Мінскам',
    options: ['Мінск', 'Мінску', 'Мінскам'],
    answer: 1,
    hints: [
      '"У" (in) with location requires the locative case.',
      'Locative of Мінск is Мінску.',
      'It is either (a) or (b).',
    ],
  },
  {
    level: 'B2',
    topic: 'verbal aspect',
    prompt: 'Complete: "Учора я ___ гэтую кнігу." (a) чытаў (b) прачытаў (c) чытаю',
    options: ['чытаў', 'прачытаў', 'чытаю'],
    answer: 1,
    hints: [
      '"Учора" + completed action. Think about aspect.',
      'A completed action in the past needs perfective aspect.',
      'It is either (a) or (b).',
    ],
  },
  {
    level: 'C1',
    topic: 'participle / дзеепрыслоўе',
    prompt: 'Complete: "Прачытаўшы кнігу, ён ___." (a) заснуў (b) заснуўшы (c) засынаў',
    options: ['заснуў', 'заснуўшы', 'засынаў'],
    answer: 0,
    hints: [
      'After a дзеепрыслоўе (gerund), the main clause needs a finite verb.',
      'The main clause needs a completed past tense verb (perfective).',
      'It is either (a) or (c).',
    ],
  },
];
...
class StudyPlanner {
  ...
  getTodaySession(id) {
    ...
    return {
      ...
      streak,
      motivation: streak > 0
        ? `${streak}-day streak! Keep building momentum. Кожны новы дзень мае значэнне.`
        : 'Start a new streak today. Every session counts. Кожны новы носьбіт беларускай мовы дапамагае яе захаваць.',
    };
  }
  ...
  getReport(id) {
    ...
    return {
      ...dash,
      report: {
        currentMilestones: milestones.map(m => ({ achieved: lvl, en: m.en, be: m.be })),
        nextLevel: nextLvl || 'max',
        nextMilestones: nextMilestones.map(m => ({ target: nextLvl, en: m.en, be: m.be })),
  ...
  _recommendation(p) {
    ...
    // Belarusian-specific
    parts.push('Remember: every new Belarusian speaker helps keep this language alive.');
  ...
  _resources() {
    return {
      courses: ['Mova.pro (online course)', 'Mova Nanova (YouTube)'],
      radio: ['Радыё Свабода (svaboda.org)'],
      tv: ['Белсат (belsat.eu)'],
      news: ['Наша Ніва (nn.by)'],
      dictionaries: ['Slounik.org', 'Skarnik.by'],
      grammar: ['Verbix Belarusian verb conjugator'],
      literature: ['Якуб Колас', 'Янка Купала', 'Васіль Быкаў'],
      community: ['r/belarusian (Reddit)', 'Telegram groups'],
    };
  }
}
